...
Namespace Dashboard_DashboardLoading
	Partial Public Class WebForm1
		...
		Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
			...
			' Includes the jQuery library in a web application.
			ASPxDashboardViewer1.RegisterJQuery = True
        ...
        Protected Sub ASPxDashboardViewer1_DashboardLoading( _
                      ByVal sender As Object, _
                      ByVal e As DevExpress.DashboardWeb.DashboardLoadingEventArgs)
        ...
        Protected Sub ASPxDashboardViewer1_ConfigureDataConnection( _
                      ByVal sender As Object, _
